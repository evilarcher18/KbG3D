...
#define KG_WINDOW_TITLE                     "KbG 3D Praktika - Ingurune Birtual Nagusia"
...
#define KG_COL_BACK_G                       1.00f
#define KG_COL_BACK_B                       1.00f
#define KG_COL_BACK_A                       1.00f

#define KG_COL_SELECTED_R                   0.60f
#define KG_COL_SELECTED_G                   0.75f
#define KG_COL_SELECTED_B                   0.10f
...
struct object3d{
    ...
    GLdouble * matrix;			/* objektuaren transformazioetarako matrizeak */
